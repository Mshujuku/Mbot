...
# Date: 2022/8/27
# Author: M叔
# Introduction: 处理群消息内容

import re
from datetime import datetime
import itchat

from Mbot.utils import config
from Mbot.control.calendar.rt_calendar import get_rtcalendar
from Mbot.utils.data_collection import (
    get_weather_info,
    get_bot_info,
)
from Mbot.control.rubbish.atoolbox_rubbish import (
    get_atoolbox_rubbish
)
from Mbot.control.moviebox.maoyan_movie_box import (
    get_maoyan_movie_box
)
from Mbot.control.express.kdniao_express import (
    get_express_info
)
from Mbot.control.airquality.air_quality_aqicn import (
    get_air_quality
)

from Mbot.utils.db_helper import (
